import type { LabelTemplateConfig } from '@/features/labels/types/label.types'
...
export function getLabelTemplate(id: LabelTemplateConfig['id']) {
...
export function getLabelTemplateName(id: LabelTemplateConfig['id']): string {
  return getLabelTemplate(id).name
}
